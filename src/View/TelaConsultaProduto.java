...
public class TelaConsultaProduto extends JFrame {
    ...
    private JButton btnOrdemAlfabetica, btnOrdemCodigoProduto, btnSair;
    ...
    public void inicializacomponentes() {        
        ...
        btnOrdemCodigoProduto = new JButton("Ordenar por Código do Produto");
        btnSair = new JButton("Sair");
        scrollTable = new JScrollPane();

        panel.add(scrollTable);
        panel.add(btnOrdemAlfabetica);
        panel.add(btnOrdemCodigoProduto);
        panel.add(btnSair);
    }
    ...
    public void windowOpened() {
        try {
            ...
            objetoPreparedStatement = produtos.objetoConexaoBD.objetoConnection.prepareStatement(vSQL);
            ...
            JOptionPane.showMessageDialog(null, "Comando SQL inválido! WINDOW OPENED " + erro.toString());
        }
    }
    ...
    public void definirEventos() {
        ...
        btnOrdemAlfabetica.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                vSQL = "select * from produtos order by descricao";
                carregaTable();
            }
        });
        btnOrdemCodigoProduto.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                vSQL = "select * from produtos order by codprod";
                carregaTable();
            }
        });
    ...
    public void carregaTable() {
        ...
        try {
            ...
            //vSQL = "select * from produto order by Nome";
            objetoPreparedStatement = produtos.objetoConexaoBD.objetoConnection.prepareStatement(vSQL);
            objetoResultSet = objetoPreparedStatement.executeQuery();
            ...
            JOptionPane.showMessageDialog(null, "Comando SQL inválido! CARREGA TABLE " + erro.toString());
        }
    }
}
